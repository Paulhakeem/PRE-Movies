...
<template>
  ...
  <main>
    <div class="px-6 py-8">
      <h2 class="section-title mb-8">What's Popular</h2>
    </div>
    <div
    ...
    >
      <div v-for="movie in movies" :key="movie.id" class="movie-card group">
        ...
        <div class="p-4">
          <div class="mb-2">
            <span
              class="inline-block bg-orange-500/30 text-orange-400 text-xs px-3 py-1 rounded-full font-semibold"
            >
              {{ movie.media_type }}
            </span>
          </div>
          ...
          <div class="flex items-center justify-between text-xs text-gray-400">
            ...
            <span v-if="movie.vote_average" class="text-orange-400 font-bold"
